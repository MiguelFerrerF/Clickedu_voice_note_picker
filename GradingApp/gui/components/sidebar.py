...
class Sidebar(ctk.CTkFrame):
    def __init__(self, master, config_path, display_names, 
                 on_class_select, on_export_notes, on_toggle_stats, **kwargs):
    ...
    def _build_ui(self):
        ...
        self.btn_export_excel = ctk.CTkButton(self, text="Exportar Notas", command=self.on_export_notes, state="disabled", fg_color="#2ECC71", hover_color="#27AE60", text_color="white", height=40)
